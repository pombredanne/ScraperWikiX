...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field members on 'Vault'
    ...
    def backwards(self, orm):
        ...
        db.create_table('codewiki_vault', (
            ...
            ('plan', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('codewiki', ['Vault'])

        # Adding M2M table for field members on 'Vault'
        db.create_table('codewiki_vault_members', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('vault', models.ForeignKey(orm['codewiki.vault'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('codewiki_vault_members', ['vault_id', 'user_id'])

        # Changing field 'Code.vault'
        db.alter_column('codewiki_code', 'vault_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['codewiki.Vault']))
    ...
    models = {
        ...
        'codewiki.code': {
            ...
            'vault': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'code_objects'", 'null': 'True', 'to': "orm['models.Vault']"}),
